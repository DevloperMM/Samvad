        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              <div className="size-12 rounded-xl bg-primary/10 flex items-center justify-center hover:bg-primary/25 transition-colors">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="form-control">
              <label className="label">
                <span className="label-text font-medium pb-1.5">Full Name</span>
              </label>
          ...
          <div className="text-center">
            <p className="text-base-content/60">
              ...
              <Link to="/login" className="link-primary">
                Log in <ArrowRight className="size-4 inline-block" />
              </Link>
            </p>
          </div>
        </div>
